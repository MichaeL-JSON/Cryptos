...
export class Migration1696777185340 implements MigrationInterface {
    name = 'Migration1696777185340'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "articles" ADD "slug" character varying NOT NULL DEFAULT ''`);
        ...
        await queryRunner.query(`ALTER TABLE "articles" ADD "tagList" text NOT NULL DEFAULT '[]'`);
